...
export function showConfirmModal({ title = 'Confirm Action', message = 'Are you sure?', confirmText = 'Confirm', cancelText = 'Cancel', onConfirm }) {
    ...
    modalOverlay.innerHTML = `
      <div class="admin-modal-card">
        ...
        <div class="admin-modal-footer">
          <button class="btn-admin-secondary" id="btnConfirmCancel">Cancel</button>
          <button class="btn-admin-danger" id="btnConfirmAction">Confirm</button>
        </div>
      </div>
    `;
  ...
  modalOverlay.style.cssText = 'display: flex !important; visibility: visible !important; opacity: 1 !important; z-index: 50000 !important;';
  document.body.classList.add('modal-open');

  const cleanup = () => {
    modalOverlay.style.cssText = 'display: none !important; visibility: hidden !important; opacity: 0 !important;';
